      ...
      <div className="max-w-7xl mx-auto p-6 bg-white dark:bg-gray-800 shadow-lg rounded-xl">
        ...
        >
          <div className="flex flex-col gap-y-4">
            ...
            <button
              onClick={cart.clear}
              className="bg-gray-300 hover:bg-orange-500 text-gray-700 hover:text-white px-6 py-3 rounded-full font-semibold shadow-lg transition duration-300 transform hover:scale-105 flex items-center gap-2"
            >
              <span>{t(LanguageTexts.cart.clearCart)}</span>
              <span className="hidden hover:inline-block">😢</span>
            </button>
          </div>
